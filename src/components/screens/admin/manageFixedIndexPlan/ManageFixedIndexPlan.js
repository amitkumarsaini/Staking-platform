  ...
  return !updateComponent ? (
    <Container fluid className="contentWrapper_main">
      <Container className="table_style" fluid>
        <NavbarTop />
        <HeaderAdmin title="Manage Fixed Index Plan">
          <ButtonCustom
    ...
    <Plans
      currentPlan={[currentPlan.drop, currentPlan.risk, currentPlan.risk]}
      action={action}
      id={id}
...
export default ManageFixedIndexPlan;
